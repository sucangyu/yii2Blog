...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-12-27 09:03:56
...
--
ALTER TABLE `relation_post_tags`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增ID', AUTO_INCREMENT=30;
--
